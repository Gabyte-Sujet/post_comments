...
abstract class $CommentCopyWith<$Res> {
  ...
  $Res call({int postId, String body});
}
...
class _$_Comment implements _Comment {
  _$_Comment({required this.postId, required this.body});
  ...
  @override
  String toString() {
    return 'Comment(postId: $postId, body: $body)';
  }
...
abstract class _Comment implements Comment {
  factory _Comment({required final int postId, required final String body}) =
      _$_Comment;
